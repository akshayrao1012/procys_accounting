...
import { Plus, Minus, CalendarIcon, FileText, Euro, Percent, Hash, Info, Shield, QrCode, Download, Eye, Send } from 'lucide-react'
...
export default function VerifactuInvoiceForm() {
  ...
  const handleGenerateInvoice = async () => {
    ...
    try {
      ...
      setIsLoading(false)
      alert("Invoice generated successfully! (Check console for data)")
    } catch (err: any) {
